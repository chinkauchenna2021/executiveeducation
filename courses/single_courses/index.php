...
if(isset($_GET['c'])):
$pid=intval($_GET['c']);
$query=mysqli_query($con,"SELECT * FROM `courses` WHERE (`id`='$pid' AND `active`=1)");
$row=mysqli_fetch_array($query) ;

// echo htmlentities($row['postingdate']);

// $years = date("M d, Y ",strtotime($row['postingdate']));
...
<head>
    ...
    <script src=../../wp-content/cache/minify/9/254b9.js> </script> <script
    ...
    <link rel=alternate type=application/json href=../../wp-json/wp/v2/courses/2024>
        <link rel=EditURI type=application/rsd+xml title=RSD
        href=../../xmlrpc.php?rsd> <link rel=wlwmanifest
    ...
    <link rel=alternate type=application/json+oembed
        href="../../wp-json/oembed/1.0/embed?url=https%3A%2F%2Fthemes.pixelwars.org%2Fefor%2Fdemo-06%2Fcourses%2Fthe-complete-javascript-course-2019-build-real-projects%2F">
    <link rel=alternate type=text/xml+oembed
        href="../../wp-json/oembed/1.0/embed?url=https%3A%2F%2Fthemes.pixelwars.org%2Fefor%2Fdemo-06%2Fcourses%2Fthe-complete-javascript-course-2019-build-real-projects%2F&#038;format=xml">
    <style>
        
    </style>
    <meta property="og:type" content="website">
    <meta property="og:image"
        content="../../wp-content/uploads/sites/9/2019/05/course1-1-1.jpg">
    <meta property="og:description"
        content="&lt;strong&gt;Are you new to PHP or need a refresher?&lt;/strong&gt; Then this course will help you get all the fundamentals of Procedural PHP, Object Oriented PHP, MYSQLi and ending the course by building a CMS system similar to WordPress, Joomla or Drupal. &lt;strong&gt;Knowing PHP has allowed me to make enough money to stay home and make courses like this one for students all over the world.&lt;/strong&gt; Being a PHP developer can allow anyone to make really good money online and offline, developing dynamic applications. Knowing &lt;strong&gt;PHP &lt;/strong&gt;will allow you to build web applications, websites or Content Management systems, like WordPress, Facebook, Twitter or even Google. &lt;strong&gt;There is no limit to what you can do with this knowledge.&lt;/strong&gt; PHP is one of the most important web programming languages to learn, and knowing it, will give you &lt;strong&gt;SUPER POWERS&lt;/strong&gt; in the web development world and job market place. &lt;strong&gt;Why?&lt;/strong&gt; Because Millions of websites and applications (the majority) use PHP. You can find a job anywhere or even work on your own, online and in places like freelancer or Odesk. You can definitely make a substantial income once you learn it. &lt;strong&gt;I will not bore you :)&lt;/strong&gt; I take my courses very seriously but at the same time I try to make it fun since I know how difficult learning from an instructor with a monotone voice or boring attitude is. This course is fun, and when you need some energy to keep going, you will get it from me. &lt;strong&gt;My Approach&lt;/strong&gt; Practice, practice and more practice. Every section inside this course has a practice lecture at the end, reinforcing everything with went over in the lectures. I also created a small application the you will be able to download to help you practice PHP. To top it off, we will build and awesome CMS like WordPress, Joomla or Drupal.">
    ...
    <link rel=apple-touch-icon
        ...
        <script src="https://kit.fontawesome.com/ca817032d3.js" crossorigin="anonymous"></script>
</head>

<body data-rsssl=1
    class="courses-template-default single single-courses postid-2024 theme-efor woocommerce-no-js elementor-default elementor-kit-2713">
    <div id=page class="hfeed site">
                        ...
                        <div class=site-branding-wrap>
                            <div class=site-branding-center>
                                <h1 s class="site-title"> <a href= rel=home>
                                        <span class=screen-reader-text> Atlanta Graduate School</span> <span style="font-size:33px !important;"  class=site-title-text>
                                ...
                                <div class=nav-menu>
                                    <ul id=menu-mymenu class>
                                        ...
                                        <li id=menu-item-1539
                                            class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item menu-item-1539">
        ...
        <div
            class="tutor-wrap tutor-full-width-course-top tutor-course-top-info tutor-page-wrap post-2024 courses type-courses status-publish has-post-thumbnail hentry course-category-development course-category-heath-fitness course-category-javascript course-category-marketing course-category-math course-category-photography course-tag-app-development course-tag-javascript is-cat-link-solid-light is-cat-link-rounded">
            <div class=tutor-container>
                <div class=tutor-row>
                    <div class="tutor-col-8 tutor-col-md-100">
                        <div class="tutor-single-course-segment tutor-single-course-lead-info">
                            <div class=tutor-leadinfo-top-meta> <span class=tutor-single-course-rating>
                                    <div class=tutor-star-rating-group><i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
                                        <i class="far fa-star"></i>
                                        <div class=tutor-rating-gen-input><input type=hidden name=tutor_rating_gen_input
                                                value=4.00></div>
                                    </div> <span class=tutor-single-rating-count> 4.00<i>(2)</i> </span>
                                </span></div>
                            <h1 class="tutor-course-header-h1"><?php echo $row['course_title'];    ?></h1>
                            <div class="tutor-single-course-meta tutor-meta-top">
                                <!-- <ul>
                                    <li class=tutor-single-course-author-meta>
                                        <div class=tutor-single-course-avatar> <a
                                                href=../../profile/pixelwars> <img
                                                decoding=async
                                                src=https://mltgfb8sgh5y.i.optimole.com/3Vuqt6I.vAfL~2a7bd/w:150/h:150/q:90/rt:fill/g:ce/../../wp-content/uploads/sites/9/2020/05/62349-1920a.jpg
                                                class=tutor-image-avatar alt> </a></div>
                                        <div class=tutor-single-course-author-name> <span>by</span> <a
                                                href=../../profile/pixelwars>Developer
                                                </a> </div> </li> <li class=tutor-course-level> <strong>Course
                                                    level:</strong> Intermediate
                                    </li>
                                    <li class=tutor-social-share> <span>Share:</span>
                                        <div class=tutor-social-share-wrap
                                            data-social-share-config="{&quot;title&quot;:&quot;The Complete JavaScript Course 2019&quot;,&quot;text&quot;:&quot;Do you want to learn the number #1 programming language that powers the internet? Are you tired of wasting your time and money on random youtube videos or JavaScript courses that are either too simple, or too difficult to follow? Or are you struggling to deeply understand and apply JavaScript to real projects? If your answer is a big YES... Then this is exactly the course you are looking for!&quot;,&quot;image&quot;:&quot;https:\/\/mltgfb8sgh5y.i.optimole.com\/3Vuqt6I.vAfL~2a7bd\/w:auto\/h:auto\/q:90\/https:\/\/themes.pixelwars.org\/efor\/demo-06\/wp-content\/uploads\/sites\/9\/2019\/05\/course1-1-1.jpg&quot;}">
                                            <button class="tutor_share s_facebook"> <i class="fab fa-facebook"></i>
                                            </button><button class="tutor_share s_twitter"> <i class="fab fa-twitter"></i></i> </button><button
                                                class="tutor_share s_linkedin"> <i class="fab fa-linkedin"></i>
                                            </button><button class="tutor_share s_tumblr"> <i class="fab fa-tumblr"></i> </button></div>
                                    </li>
                                </ul> -->
                            </div>
                            <div class="tutor-single-course-meta tutor-lead-meta">
                                <!-- <ul>
                                    <li> <span>Categories</span> <a
                                            href=../../course-category/development/>Development</a><a
                                            href=../../course-category/heath-fitness/>Heath
                                            & Fitness</a><a
                                            href=../../course-category/javascript/>JavaScript</a><a
                                            href=../../course-category/marketing/>Marketing</a><a
                                            href=../../course-category/math/>Math</a><a
                                            href=../../course-category/photography/>Photography</a>
                                    </li>
                                    <li> <span>Duration</span> 18h 20m </li>
                                    <li> <span>Total Enrolled</span> 127 </li>
                                    <li> <span>Last Update</span> May 17, 2019 </li>
                                </ul> -->
                            </div>
                            <div class=tutor-course-summery>
                                <div class="tutor-single-course-meta tutor-meta-top">
                                <img srcset="../../admin/postimages/<?php  echo $row['course_images'];     ?>" alt="lecture" width="100%">
                                </div>
                                <h4 class="tutor-segment-title"></h4>
                                
                                <?php echo $row['course_description']; ?><br><br>
                            </div>
                        </div>
                        <div class="tutor-single-course-segment tutor-course-content-wrap">
                            <div class=course-content-title>
                                <h4 class="tutor-segment-title">COURSE OBJECTIVES</h4>
                            </div>
                            <div class=tutor-course-content-content>
                                <?php echo $row['course_objective'];     ?>
                                </ul>
                            </div>
                        </div>
                        <div class="tutor-single-course-segment tutor-course-benefits-wrap">
                            ...
                            <div class=tutor-course-benefits-content>
                                ...
                                <?php echo $row['course_curriculum'];     ?>
                                </ul>
                            </div>
                        </div>
                        
                        <div class=tutor-course-content-content>
                            <h4 class="tutor-segment-title">TARGETED PARTICIPANTS</h4>
                            <ul>
                            <?php echo $row['course_participant'];     ?> 
                            </ul>
                        </div>
                            ...
                            <div class=single-instructor-wrap>
                                <div class=single-instructor-top>
                                    <div class=tutor-instructor-left>
                                        <div class=instructor-avatar> <a
                                            > <img src="../../admin/postimages/<?php echo $row['author_images'];  ?>" alt="GEORGINA NGOZI IBERI"> </a></div>
                                        <div class=instructor-name>
                                            <h3><a href=../../profile/pixelwars><?php echo $row['author_name'];  ?>
                                                    </a> </h3> <h4><?php echo $row['author_description'] ; ?></h4>
                                        </div>
                                    </div>
                                ...
                                <div class=single-instructor-bottom>
                                    <div class=ratings> <span class=rating-generated>
                                            <div class=tutor-star-rating-group><i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star-half-alt"></i>
                                                <div class=tutor-rating-gen-input><input type=hidden
                                                        name=tutor_rating_gen_input value=4.43></div>
                                            </div>
                                        </span><span class=rating-digits>four and above</span> <span class=rating-total-meta></span></div>
                                    <!-- <div class=courses>
                                        <p> <i class="fas fa-graduation-cap"></i></i> 11 <span class=tutor-text-mute>
                                                Courses</span></p>
                                    </div>
                                    <div class=students>
                                        <p> <i class="fas fa-user-graduate"></i> 355 <span class=tutor-text-mute>
                                                students</span></p>
                                    </div> -->
                                </div>
                            </div>
                        ...
                        <div class=tutor-single-course-segment>
                            ...
                            <div class=tutor-course-reviews-wrap>
                                    ...
                                    <div class=course-avg-rating-wrap>
                                        <div class="tutor-row tutor-align-items-center">
                                            <div class=tutor-col-auto>
                                                <p class=course-avg-rating> 4.0</p>
                                                <p class=course-avg-rating-html>
                                                    <div class=tutor-star-rating-group><i class="fas fa-star"></i>
                                                        ...
                                                        <i class="far fa-star"></i>
                                                        <div class=tutor-rating-gen-input><input type=hidden
                                                                name=tutor_rating_gen_input value=4.00></div>
                                                    </div>
                                                </p>
                                            ...
                                            <div class=tutor-col>
                                                <div class=course-ratings-count-meter-wrap>
                                                    ...
                                                    <div class=course-rating-meter>
                                                        <div class=rating-meter-col><i class="far fa-star"></i>
                                                        </div>
                                                        <div class=rating-meter-col>4</div>
                                                        <div class="rating-meter-col rating-meter-bar-wrap">
                                                            <div class=rating-meter-bar>
                                                                <div class=rating-meter-fill-bar style="width: 0%">
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                <div class=tutor-course-reviews-list>
                                    <div class="tutor-review-individual-item tutor-review-http://17">
                                        <div class=review-left>
                                            <div class=review-avatar> <a
                                                    href=../../profile/user_name>
                                                    </a> </div> <div class=tutor-review-user-info>
                                                    <div class=review-time-name>
                                                        <p> <a href=../../profile/user_name>
                                                                </a> </p> <p class=review-meta> 3 years ago</p>
                                                    </div>
                                                    <div class=individual-review-rating-wrap>
                                                        <div class=tutor-star-rating-group><i class="fas fa-star"></i>
                                                            ...
                                                            <i class="fas fa-star"></i>
                                                            <div class=tutor-rating-gen-input><input type=hidden
                                                                    name=tutor_rating_gen_input value=3></div>
                                                        </div>
                                                    </div>
                                            </div>
                                        </div>
                                        <div class="review-content review-right">
                                            <p>Amazing Tutor, Many thanks for the course. You have explained the course
                                                so nicely. I thoroughly enjoyed the course and will be looking forward
                                                to your new courses.</p>
                                        </div>
                                    </div>
                                    <div class="tutor-review-individual-item tutor-review-http://16">
                                        <div class=review-left>
                                            <div class=review-avatar> <a
                                                    href=../../profile/user_name>
                                                    </a> </div> <div class=tutor-review-user-info>
                                                    <div class=review-time-name>
                                                        <p> <a href=../../profile/user_name>
                                                                </a> </p> <p class=review-meta> <?php echo $row['course_date'];  ?></p>
                                                    </div>
                                                    <div class=individual-review-rating-wrap>
                                                        <div class=tutor-star-rating-group><i class="fas fa-star"></i>
                                                            <i class="fas fa-star"></i>
                                                            ...
                                                            <i class="far fa-star"></i>
                                                            <div class=tutor-rating-gen-input><input type=hidden
                                                                    name=tutor_rating_gen_input value=5></div>
                                                        </div>
                                                    </div>
                                            </div>
                                        </div>
                                        <div class="review-content review-right">
                                            <p>This is the best course online that you can get. I learn online
                                                everything about web development, but this is amazing. Thank's Jonas,
                                                you are my Hero. You give me a good knowledge of Html, CSS and
                                                Javascript.</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class=tutor-price-preview-box>
                                <div class=tutor-price-box-thumbnail>
                                    <div class="tutor-single-lesson-segment tutor-lesson-video-wrap">
                                        <div class=plyr__video-embed id=tutorPlayer> <iframe
                                                src="<?php echo $row['video_url'];  ?>"
                                                allowfullscreen allowtransparency allow=autoplay></iframe></div>
                                    </div>
                                </div>
                                <div class=price>$<?php   echo $row['course_price']; ?></div>
                                <div class="tutor-single-course-segment  tutor-course-material-includes-wrap">
                                    ...
                                    <div class=tutor-course-target-audience-content>
                                        <ul class="tutor-course-target-audience-items tutor-custom-list-style">
                                            <li>18 hours on-demand video</li>
                                            <li>10 articles</li>
                                ...
                                <div class="tutor-single-add-to-cart-box cart-required-login " data-login_page_url>
                                    <form class=tutor-enroll-form method=post> <input type=hidden id=_tutor_nonce
                                            name=_tutor_nonce value=0f62fae010><input type=hidden name=_wp_http_referer
                                            value=/efor/demo-06/courses/the-complete-javascript-course-2019-build-real-projects/>
                                        <input type=hidden name=tutor_course_id value=2024> <input type=hidden
                                            name=tutor_course_action value=_tutor_course_enroll_now>
                                        <div class=" tutor-course-enroll-wrap"> <button type=submit
                                                class="tutor-btn-enroll tutor-btn tutor-course-purchase-btn"> Enroll Now
                                            </button></div>
                                    </form>
                                </div>
                                <div class=tutor-cart-box-login-form style="display: none;"><span
                                        class=login-overlay-close></span>
                                            ...
                                            <div class=tutor-single-course-login-form>
                                                <div class=tutor-login-form-wrap>
                                                    <form name=loginform id=loginform method=post> <input type=hidden
                                                            name=tutor_course_enroll_attempt value=2024> <input
                                                            type=hidden id=_tutor_nonce name=_tutor_nonce
                                                            value=0f62fae010><input type=hidden name=_wp_http_referer
                                                            value=/efor/demo-06/courses/the-complete-javascript-course-2019-build-real-projects/>
                                                        <input type=hidden name=tutor_action value=tutor_user_login>
                                                        <p class=login-username> <input type=text
                                                                placeholder="Username or Email Address" name=log
                                                                id=user_login class=input value size=20></p>
                                                        <p class=login-password> <input type=password
                                                                placeholder=Password name=pwd id=user_pass class=input
                                                                value size=20></p>
                                                        <div class=tutor-login-rememeber-wrap>
                                                            <p class=login-remember> <label> <input name=rememberme
                                                                        type=checkbox id=rememberme value=forever>
                                                                    Remember Me </label></p> <a
                                                                href=../../dashboard/retrieve-password>
                                                                Forgot Password? </a> </div> <p class=login-submit>
                                                                <input type=submit name=wp-submit id=wp-submit
                                                                    class=tutor-button value="Log In"> <input
                                                                    type=hidden name=redirect_to
                                                                    value=../../courses/the-complete-javascript-course-2019-build-real-projects/>
                                                                </p>
                                                                <p class=tutor-form-register-wrap> <a
                                                                        href="../../student-registration/?redirect_to=../../courses/the-complete-javascript-course-2019-build-real-projects/&#038;id=2024">
                            ...
                            <div class="tutor-single-course-segment  tutor-course-requirements-wrap">
                                ...
                                <div class=tutor-course-requirements-content>
                                    <ul class="tutor-course-requirements-items tutor-custom-list-style">
                                       <?php echo $row['course_requirement']; ?>
                                    </ul>
                                </div>
                            </div>
                        </div>
        ...
        <footer id=colophon class=site-footer role=contentinfo>
            <div class=footer-insta>
                <div class="textwidget custom-html-widget">
                    <style>
                        #insta-gallery-feed-901194280 .insta-gallery-list .insta-gallery-item .insta-gallery-image-wrap .insta-gallery-image-mask {
                            background-color: #000
                        }
                    </style>
                    <div id=insta-gallery-feed-901194280 class="insta-gallery-feed insta-gallery-square"
        ...
        <div class=tutor-cart-box-login-form-inner><button
            ...
            <div class="tutor-single-course-segment tutor-course-login-wrap">
                ...
                <div class=tutor-single-course-login-form>
                    <div class=tutor-login-form-wrap>
                        <form name=loginform id=loginform method=post> <input type=hidden
                                name=tutor_course_enroll_attempt value=2024> <input type=hidden id=_tutor_nonce
                                name=_tutor_nonce value=0f62fae010><input type=hidden name=_wp_http_referer
                                value=/efor/demo-06/courses/the-complete-javascript-course-2019-build-real-projects/>
                            <input type=hidden name=tutor_action value=tutor_user_login>
                            ...
                            <div class=tutor-login-rememeber-wrap>
                                <p class=login-remember> <label> <input name=rememberme type=checkbox id=rememberme
                                    ...
                                    <p class=tutor-form-register-wrap> <a
                                            href="../../courses/the-complete-javascript-course-2019-build-real-projects/&#038;id=2024">
                                            Create a new account </a></p>
                        </form>
                    </div>
                </div>
    ...
    <script src=../../wp-content/cache/minify/9/cd23e.js> </script> <script
