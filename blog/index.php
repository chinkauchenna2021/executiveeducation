                        ...
                        <div class=menu-wrap>
                            <div class=layout-medium> <a class=menu-toggle> <span class=lines></span> </a> <a
                                ...
                                <li id=menu-item-1828
                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1828 current-menu-item">
                                    <a href=../blog />Blog</a>
                                </li>
                                    ...
                                    <div class=post-wrap>
                                        <header class=entry-header>
                                            ...
                                            <div class=entry-meta> <span class=cat-links> <a
                                                        href=#
                                                        rel="category tag"><?php echo htmlentities($row['category']);?></a> </span>
                                                </div>
                ...
                <div id=primary class="content-area with-sidebar">
                    <div id=content class=site-content role=main>
                        <div class="post-header post-header-classic archive-header">
                            <header class=entry-header>
                                <h1 class="entry-title"> <span class=cat-title>Blog Section</span></h1>
                            </header>
                        </div>
...
?>
                            ...
                            <article id=post-1292
                                ...
                                <div class=featured-image
                                    style="background-image: url(../admin/postimages/<?php echo htmlentities($row['PostImage']);?>);">
                                    <a
                                    href="./single_blog/index.php?single=<?php echo htmlentities($row['pid'])?>"  >
                                        <img decoding=async width=1060 height=707
                                            src=url(../admin/postimages/<?php echo htmlentities($row['PostImage']);?>)
                                    ...
                                    <header class=entry-header>
                                        <div class="entry-meta above-title">
                                             <span class=cat-links>
                                                  <span class=prefix>
                                                    ...
                                                    <time class=updated datetime=<?php echo htmlentities($row['postingdate']);?>> <?php echo htmlentities($row['postingdate']);?>
                                                    </time> </a> </span></div>
                                        <h2 class="entry-title"> <a
                                                href="./single_blog/index.php?single=<?php echo htmlentities($row['pid'])?>" >
                                                <?php echo htmlentities($row['posttitle']);?></a></h2>
                                        <div class="entry-meta below-title"> <span class=entry-share> <span
                                                    ...
                                                    <span class=entry-share-inner-wrap> <a class=share-facebook
                                                            ...
                                                            href="https://www.facebook.com/sharer.php?u=<?php echo htmlentities($row['posttitle']);?>"
                                                            title="Share this post on Facebook">Facebook</a> <a
                                                            class=share-twitter rel=nofollow target=_blank
                                                            href="https://twitter.com/intent/tweet?text=<?php echo htmlentities($row['posttitle']);?>"
                                                            title="Tweet this post to your followers">Twitter</a> <a
                                                            class=share-pinterest rel=nofollow target=_blank
                                                            href="https://pinterest.com/pin/create/button/?url=<?php echo htmlentities($row['posttitle']);?>"
                                                            title="Pin it">Pinterest</a> <a class=share-mail
                                                            rel=nofollow target=_blank
                                                            href="mailto:?subject=<?php echo htmlentities($row['posttitle']);?>"
                                                            title="Email this post to a friend">Email</a> </span>
                                                </span> </span>  </span> </div>
                                    </header>
                                    <div class=entry-content>
                                        <p><?php echo substr(strip_tags($row['postdetails']),0,300);?>&#8230;</p>
                                        <p class=more><a class=more-link
                                                href="./single_blog/index.php?single=<?php echo htmlentities($row['pid'])?>" >Read
                                                More</a></p>
                                    </div>
                                </div>
                            </article>
...
?>
                                    ...
                                    <li> <a
                                        href="./single_blog/index.php?single=<?php echo htmlentities($row['pid'])?>"/>
                                        <?php echo htmlentities($row['posttitle']);?>  </a> </li>
