...
$query=mysqli_query($con,"select tblposts.PostTitle as posttitle,tblposts.PostDetails as postdetails,tblposts.PostImage,tblcategory.CategoryName as category,tblcategory.id as cid,tblsubcategory.Subcategory as subcategory,tblposts.PostDetails as postdetails,tblposts.PostingDate as postingdate,tblposts.PostUrl as url from tblposts left join tblcategory on tblcategory.id=tblposts.CategoryId left join  tblsubcategory on  tblsubcategory.SubCategoryId=tblposts.SubCategoryId where tblposts.id='$pid'");
...
<head>
    ...
    <link rel=profile href=https://gmpg.org/xfn/11> <title><?php  echo $row['posttitle'];   ?> &#8211; AGSchool</title>
            ...
            <div class=layout-medium>
                <div class="post-header post-header-overlay is-post-dark is-cat-link-solid-light is-cat-link-rounded">
                    <div class=post-thumbnail
                        style="background-image: url(../../admin/postimages/<?php echo $row['PostImage'] ;  ?>);"
                        data-medium-image=../../admin/postimages/<?php echo $row['PostImage'] ;  ?>
                        data-large-image=../../admin/postimages/<?php echo $row['PostImage'] ;  ?>>
                        <div class=post-wrap>
                        <header class=entry-header>
                            <h1 class="entry-title"><?php echo $row['posttitle']; ?></h1>
                            <div class="entry-meta below-title"> <span class=cat-links> <span class=prefix> in </span>
                                    <a 
                                        rel="category tag"><?php echo htmlentities($row['category']);?></a> </span> <span class=posted-on> <span class=prefix>
                                        on </span> <a
...
<?php
                    ...
                    $query=mysqli_query($con,"select tblposts.id as pid,tblposts.PostTitle as posttitle,tblposts.PostDetails as postdetails,tblposts.PostImage,tblcategory.CategoryName as category,tblcategory.id as cid,tblsubcategory.Subcategory as subcategory,tblposts.PostDetails as postdetails,tblposts.PostingDate as postingdate,tblposts.PostUrl as url from tblposts left join tblcategory on tblcategory.id=tblposts.CategoryId left join  tblsubcategory on  tblsubcategory.SubCategoryId=tblposts.SubCategoryId where tblposts.Is_Active=1 order by tblposts.id desc  LIMIT 0 , 2");
                                ...
                                <div class=post-wrap>
                                    <header class=entry-header>
                                        <div class=entry-meta> <span class=cat-links><a
                                                    href="index.php?single=<?php   echo $row['pid'];     ?>"
                                                    rel="category tag"><?php echo $row['category']   ?></a></span></div>
                                        <h2 class="entry-title"> <a
                                        href="index.php?single=<?php   echo $row['pid'];     ?>">
                                                  <?php   echo  $row['posttitle'];?></a></h2> <a class=more-link
                                                  href="index.php?single=<?php   echo $row['pid'];     ?>" ></a>
                                    </header>
                                </div>
                            </div>
                        </div>
