...
<head>
    ...
    <link rel=EditURI type=application/rsd+xml title=RSD href=https://themes.pixelwars.org/efor/demo-06/xmlrpc.php?rsd>
        <link rel=wlwmanifest type=application/wlwmanifest+xml
        href=https://themes.pixelwars.org/efor/demo-06/wp-includes/wlwmanifest.xml> 
        <meta name="generator"
        content="WordPress 5.8.3">
...
<body data-rsssl=1 class="blog theme-efor woocommerce-no-js elementor-default elementor-kit-2713">
                ...
                <div class=featured-area>
                    <div class="block slider-box  ratio-21-9">
                        ...
                        <div class="post-slider owl-carousel   " data-items=1 data-animation=fadeVertical data-nav=true
                            data-dots=true data-mouse-drag=false data-autoplay=false data-autoplay-timeout=4000
                            data-center=false data-loop=true data-rewind=true>
                            <?php 

$query=mysqli_query($con,"SELECT * FROM `conference` WHERE `active` = 1 LIMIT 5");
...
?>
                            ...
                            <div class="slider-post main-slider-post is-post-dark is-cat-link-line-before">
                                <div class=post-thumbnail
                                    style="background-image: url(../admin/postimages/<?php echo htmlentities($row['conf_images']);?>);">
                                    <div class=post-wrap>
                                        <header class=entry-header>
                                            <h2 class="entry-title"> 
                                                <a
                                                    href=#/>
                                                    <?php echo htmlentities($row['conf_title']);?> </a>
                                                </h2>
                ...
                <div id=primary class="content-area with-sidebar">
                    <div id=content class=site-content role=main>
                        <div class="post-header post-header-classic archive-header">
                            <header class=entry-header>
                                <h1 class="entry-title"> <span class=cat-title>Conference Section</span></h1>
                            </header>
                        </div>
...
$query=mysqli_query($con,"SELECT * FROM `conference` ORDER BY `id` DESC ");
while ($row=mysqli_fetch_array($query)) {
?>
                            ...
                            <article id=post-1292
                                class="post-1292 post type-post status-publish format-standard has-post-thumbnail hentry category-life tag-improve tag-life tag-self is-cat-link-solid-light is-cat-link-rounded">
                                <div class=featured-image
                                    style="background-image: url(../admin/postimages/<?php echo htmlentities($row['conf_images']);?>);">
                                    <a
                                    href="./single_conf/index.php?single=<?php echo htmlentities($row['id'])?>"  >
                                        <img decoding=async width=1060 height=707
                                            src=url(../admin/postimages/<?php echo htmlentities($row['conf_images']);?>)
                                            class="attachment-efor_image_size_1 size-efor_image_size_1 wp-post-image"
                                            alt> </a></div>
                                        ...
                                        <div class="entry-meta above-title">
                                             <span class=cat-links>
                                                     ...
                                                     <span class=posted-on>
                                                          <span
                                                    class=prefix> on </span> <a
                                                    href="./single_blog/index.php?single=<?php echo htmlentities($row['id'])?>"
                                                    rel=bookmark> <time class="entry-date published"
                                                        datetime=<?php echo htmlentities($row['conf_date']);?>><?php echo htmlentities($row['conf_date']);?></time>
                                                    <time class=updated datetime=<?php echo htmlentities($row['conf_date']);?>> <?php echo htmlentities($row['cconf_date']);?>
                                                    </time> </a> </span></div>
                                        <h2 class="entry-title"> <a
                                                href="./single_conf/index.php?single=<?php echo htmlentities($row['id'])?>" >
                                                <?php echo htmlentities($row['conf_title']);?></a></h2>
                                        <div class="entry-meta below-title"> <span class=entry-share> <span
                                                    class=entry-share-text>Share</span> <span class=entry-share-wrap>
                                                    <span class=entry-share-inner-wrap> <a class=share-facebook
                                                            rel=nofollow target=_blank
                                                            href="https://www.facebook.com/sharer.php?u=<?php echo htmlentities($row['conf_title']);?>"
                                                            title="Share this post on Facebook">Facebook</a> <a
                                                            class=share-twitter rel=nofollow target=_blank
                                                            href="https://twitter.com/intent/tweet?text=<?php echo htmlentities($row['conf_title']);?>"
                                                            title="Tweet this post to your followers">Twitter</a> <a
                                                            class=share-pinterest rel=nofollow target=_blank
                                                            href="https://pinterest.com/pin/create/button/?url=<?php echo htmlentities($row['conf_title']);?>"
                                                            title="Pin it">Pinterest</a> <a class=share-mail
                                                            rel=nofollow target=_blank
                                                            href="mailto:?subject=<?php echo htmlentities($row['conf_title']);?>"
                                                            title="Email this post to a friend">Email</a> </span>
                                                </span> </span>  </span> </div>
                                    </header>
                                    <div class=entry-content>
                                        <p><?php echo substr(strip_tags($row['conf_description']),0,300);?>&#8230;</p>
                                        <p class=more><a class=more-link
                                                href="./single_conf/index.php?single=<?php echo htmlentities($row['id'])?>" >Read
                                                More</a></p>
                                    </div>
                                </div>
                            </article>
                            ...
                            <aside id=search-2 class="widget widget_search">
                                <form role=search method=get class=search-form
                                    action=../> <label> <span
                                            ...
                                            class=search-field placeholder="Search &hellip;" value name=s> </label>
...
$query=mysqli_query($con,"SELECT * FROM `conference` WHERE `active` = 1  ORDER BY `id` DESC LIMIT 5");
while ($row=mysqli_fetch_array($query)) {
?>
                                    ...
                                    <li> <a
                                        href="./single_conf/index.php?single=<?php echo htmlentities($row['id'])?>"/>
                                        <?php echo htmlentities($row['conf_title']);?>  </a> </li>
...
?>
                                    ...
                                    <!-- <li> <a
                                            href=../self-love-is-the-basis-for-self-improvement/>Self-love
                                            is the basis for self-improvement</a> </li> -->
                                </ul>
                            </aside>
        ...
        <footer id=colophon class=site-footer role=contentinfo>
            <div class=footer-insta>
                <div class="textwidget custom-html-widget">
                    <style>
                        #insta-gallery-feed-401308060 .insta-gallery-list .insta-gallery-item .insta-gallery-image-wrap .insta-gallery-image-mask {
                            background-color: #000
                        }
                    </style>
                    <div id=insta-gallery-feed-401308060 class="insta-gallery-feed insta-gallery-square"
                ...
                <div class=tutor-single-course-login-form>
                    <div class=tutor-login-form-wrap>
                        <form name=loginform id=loginform method=post> <input type=hidden
                                ...
                                value=/efor/demo-06/blog/> <input type=hidden name=tutor_action value=tutor_user_login>
                            ...
                            <div class=tutor-login-rememeber-wrap>
                                <p class=login-remember> <label> <input name=rememberme type=checkbox id=rememberme
                                    ...
                                    Password? </a> </div> <p class=login-submit> <input type=submit name=wp-submit
                                        ...
                                        name=redirect_to value=../blog/></p>
                                    <p class=tutor-form-register-wrap> <a
                                            href="../student-registration/?redirect_to=../how-to-supercharge-your-learning-and-self-improvement-the-golden-ratio-of-communication/">
    ...
    <script src=../wp-content/cache/minify/9/fba59.js> </script> <script
        id=wp-i18n-js-after>
    ...
    <script src=../wp-content/cache/minify/9/404bb.js> </script> </body> </html>