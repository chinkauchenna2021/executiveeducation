...
$pid = intval($_GET['prof']);
$query = mysqli_query($con,"SELECT * FROM `staff` WHERE `id`='$pid'");
                    ...
                    <div class="row">
                        <div class="col-md-4 mt-1">
                            <div class="text-center sidebar">
                                    ...
                                    <img src="admin/postimages/<?php  echo $row['staff_image']; ?>" alt=""  class="round" >
                        ...
                        <div class="col-md-8 mt-1">
                            <div class="card mb-3 content">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <h5>Staff Facebook URL</h5>
                                        </div>
                                        <div class="col-md-9 text-secondary">
                                            <a href=""><?php echo $row['staff_facebook'] ; ?></a>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-9 text-secondary">
                                            ...
                                            <p class="para"><?php echo $row['staff_details'] ; ?></p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-9 text-secondary">
                                            <a href=""><?php echo $row['staff_youtube'] ; ?></a>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">
                                            <h5>Staff LiinkedIn</h5>
                                        </div>
                                        <div class="col-md-9 text-secondary">
                                            <a href=""><?php echo $row['staff_linkdin'] ; ?></a>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-9 text-secondary">
                                            <a href="github.com"><?php echo $row['staff_github'] ; ?></a>
                                        </div>
                                    </div>
...
<script src=wp-content/cache/minify/9/c8b65.js> 
</script> 
</body>
 </html>
